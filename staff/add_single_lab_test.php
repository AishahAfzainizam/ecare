                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputnm" class="col-form-label">Patient Name</label>
                                                        <input type="text" required="required" readonly name="lab_pat_name" value="<?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?>" class="form-control" id="nameinput" placeholder="Patient's First Name">
                                                    </div>
                                                </div>

                                                <div class="form-row">
                                                <div class="form-group col-md-4">
                                                        <label for="inputailment4" class="col-form-label">Patient Ailment</label>
                                                        <input required="required" type="text" readonly name="lab_pat_ailment" value="<?php echo $row->pat_ailment;?>" class="form-control"  id="inputailment4" placeholder="Patient`s Last Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4">
                                                        <label for="inputpatnum" class="col-form-label">Patient Number</label>
                                                        <input type="text" required="required" readonly name="lab_pat_number" value="<?php echo $row->pat_number;?>" class="form-control" id="inputpatnumb" placeholder="DD/MM/YYYY">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-4" style="display:none" >
                                                        ...
                                                        <input type="text" name="lab_number" value="<?php echo $pres_no;?>" class="form-control" id="inputZip" readonly>
                                                    </div>
                                                </div>

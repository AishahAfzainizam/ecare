                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-8">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Vendor Number (Auto-Generated)</label>
                                                    <input name="v_number" value="<?php echo $vendor_number;?>" class="form-control" id="inputZip" disabled>
                                            ...
                                            <div class="form-group">
                                                <label for="editor" class="col-form-label">Vendor Details</label>
                                                <textarea class="form-control" name="v_desc" id="editor" rows="5"></textarea>
                                            </div>

                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <?php 
                                                        $length = 5;    
                                                        $employee_number =  substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),1,$length);
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Employee Number (Auto-Generated)</label>
                                                    <input type="text" name="doc_number" value="<?php echo $employee_number;?>" class="form-control" id="inputZip" readonly>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
